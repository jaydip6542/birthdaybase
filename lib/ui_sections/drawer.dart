import 'package:active_ecommerce_flutter/screen_sections/newlogin.dart';
import 'package:active_ecommerce_flutter/screens/ContactUs.dart';
              ...
              children: <Widget>[
                ...
                is_logged_in.$ == true
                    ? ListTile(
                        visualDensity:
                            VisualDensity(horizontal: -4, vertical: -4),
                        leading: Image.asset("assets/wallett.png",
                            height: 16, color: Color.fromRGBO(153, 153, 153, 1)),
