...
class Home extends StatefulWidget {
  Home({Key key, this.title, this.show_back_button = false, go_back = false})
      : super(key: key);
...
class _HomeState extends State<Home> with TickerProviderStateMixin {
  ...
  ScrollController _categoreScrollController;
  ...
  final bool is_top_category = false;
                            ...
                            child: Column(
                              children: [
                                Padding(
                                  ...
                                  child: buildHomeCategoriesgride(context),
                                ),
                              ],
                            ),
                          ),
  ...
  buildHomeCategoriesgride(context){
    if (_isCategoryInitial && _featuredCategoryList.length == 0) {
      ...
      return GridView.builder(
        ...
        controller: _categoreScrollController,
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return
                      CategoryList(
                        parent_category_id: _featuredCategoryList[index].id,
                        parent_category_name: _featuredCategoryList[index].name,
                      );
                  }));
                  // Navigator.push(context, MaterialPageRoute(builder: (context) {
                  //   return CategoryProducts(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () async {
            ...
            // openwhatsapp();
            await launch(
                "https://wa.me/${917984079900}?text=Hello,How can i help you?");
          },
          child: Container(
            height: 100,
            width: MediaQuery.of(context).size.width / 5 - 4,
            child: Column(
              children: [
                Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(16.0),
                      child: Image.asset("assets/whatsappicon.png"),
                    )),
                Padding(
                    padding: const EdgeInsets.only(top: 8),
