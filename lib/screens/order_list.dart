import 'package:active_ecommerce_flutter/repositories/orderdelete_repository.dart';
...
class _OrderListState extends State<OrderList> {
  ...
  onPressedDelete(id) async{
    var OrderDeleteResponse = await OrderDeleteRepository()
        .getOrderDeleteResponse( id);

    if (OrderDeleteResponse.success == false) {
     print("jaydip1");
          ...
          children: [
            ...
            Row(
              children: [
                ...
                //     child: GestureDetector(
                //      onTap: () async {
                //        String url = 'https://demo.thestationerybox.in/api/v2/invoice/${_orderList[index].id}';
                //        print(url);
                //
            ...
            Padding(
              padding: const EdgeInsets.only(bottom: 4.0,top: 7),
              child: Row(
                children: [
                  ...
                  //           showDialog(
                  //               context: context,
                  //               builder: (BuildContext context) =>_showDialogIMPS(context,_orderList[index].id));
                  //         },
                  //         child:
                  //         Container(
                  //           height: 30,
  ...
  Widget _showDialogIMPS(BuildContext context,id) {
