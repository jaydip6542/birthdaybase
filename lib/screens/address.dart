...
class _AddressState extends State<Address> {
  ...
  List<TextEditingController> _gstnoControllerListForUpdate = [];
  ...
  fetchShippingAddressList() async {
    ...
    if (_shippingAddressList.length > 0) {
      ...
      _shippingAddressList.forEach((address) {
        ...
        _gstnoControllerListForUpdate
            .add(TextEditingController(text: address.gst_no == null ?"":address.gst_no ));
  ...
  reset() {
    ...
    _gstnoControllerListForUpdate.clear();
  ...
  onAddressAdd(context) async {
    ...
    var gst_no = _gstnoController.text.toString();
 print(postal_code.length);
 print(phone);
    if (address == "") {
    ...
    if (postal_code.length > 6) {
      ToastComponent.showDialog(
          "Postal laength is 6 digit long" , context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
    ...
    if (phone.length > 10) {
      ToastComponent.showDialog(
          "Mobiler number is 10 digit long" , context,
          gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
      return;
  ...
  onAddressUpdate(context, index, id) async {
    ...
    var gst_no = _gstnoControllerListForUpdate[index].text.toString();
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          height: 40,
                          child: TextField(
                            controller: _gstnoControllerListForUpdate[index],
                            autofocus: false,
                            decoration: InputDecoration(
                                hintText: 'Enter GST NO',
                                hintStyle: TextStyle(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          width: 200,
                          child: Text(
                            _shippingAddressList[index].gst_no == null ? "--":_shippingAddressList[index].gst_no,
                            maxLines: 2,
                            style: TextStyle(
                                color: MyTheme.dark_grey,
                                fontWeight: FontWeight.w600),
