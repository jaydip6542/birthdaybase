...
class _CheckoutState extends State<Checkout> {
  ...
  fetchList() async {
    ...
    print(_paymentTypeList[1].payment_type);
    if (_paymentTypeList.length > 0) {
      _selected_payment_method = _paymentTypeList[1].payment_type;
      _selected_payment_method_key = _paymentTypeList[1].payment_type_key;
    }
    _isInitial = false;
    setState(() {});
  }
  ...
  fetchSummary() async {
    ...
    if (cartSummaryResponse != null) {
      print(cartSummaryResponse.shipping_cost);
  ...
  onPressPlaceOrderOrProceed() {
    ...
    //   if (_selected_payment_method == "razorpay") {
    //   if (_grandTotalValue == 0.00) {
    //     ToastComponent.showDialog(AppLocalizations.of(context).common_nothing_to_pay, context,
    //         gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
    //     return;
    ...
    //   });
    // } else
      if (_selected_payment_method == "paystack") {
      if (_grandTotalValue == 0.00) {
        ToastComponent.showDialog(AppLocalizations.of(context).common_nothing_to_pay, context,
            gravity: Toast.CENTER, duration: Toast.LENGTH_LONG);
        return;
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Text(
                            "Place your order. Our executive contact you soon.",
                            style: TextStyle(
                                color: Colors.black,
                                fontSize: 27,
                                fontWeight: FontWeight.w600),
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: buildPaymentMethodItemCard(1),
            );
          },
        ),
      );
