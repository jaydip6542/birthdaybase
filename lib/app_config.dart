...
class AppConfig {
  ...
  static String purchase_code = "d56dc1f4-af67-4440-9595-6199d8641972"; //enter your purchase code for the app from codecanyon
  ...
  //configure this
  static const DOMAIN_PATH = "https://demo.thestationerybox.in/"; //localhost
 ...
 // static const String RAW_BASE_URL = "${PROTOCOL}${DOMAIN_PATH}";
  static const String RAW_BASE_URL = "https://birthdaybash.in";
