...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(244, 192, 30, 1);
  static Color soft_accent_color = Color.fromRGBO(244, 192, 30, 1);
  static Color splash_screen_color = Color.fromRGBO(244, 192, 30, 1);
